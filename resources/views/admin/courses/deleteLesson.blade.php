{{-- modal delete lesson --}}
<div class="modal fade" id="deleteModal{{$lesson->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer border-0">
        <form id="form" class="form-inline"
          action="/admin/courses/{{$course->course_id}}/sections/{{$section->id}}/lessons/{{$lesson->id}}"
          method="POST">
          @csrf
          @method('DELETE')
